...
from ai_model.model_gpt_j import Model_GPT_J
...
class Controller:
    def __init__(self):
        self.problems = Problems_Dummy('./ai_data/problems_v2_eng.jsonl')
        self.model = Model_GPT_J()
        self.unit_tests = Unit_Tests_Dummy('./ai_data/tests_v2_eng.jsonl')
        self.solutions = Solutions_Dummy()
        self.results = Results_Dummy()
        self.metrics = Metrics('./metrics_gpt_j_v2_eng.xlsx')
