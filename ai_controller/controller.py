...
class Controller:
    def __init__(self):
        self.problems = Problems_Dummy('./ai_data/problems_v2_esp.jsonl')
        self.model = Model_Codex()
        self.unit_tests = Unit_Tests_Dummy('./ai_data/tests_v1_esp.jsonl')
        self.solutions = Solutions_Dummy()
        self.results = Results_Dummy()
        self.metrics = Metrics('./metrics_codex_v2_esp.xlsx')
